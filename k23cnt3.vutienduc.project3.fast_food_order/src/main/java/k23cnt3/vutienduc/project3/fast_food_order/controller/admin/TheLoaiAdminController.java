...
public class TheLoaiAdminController {
    ...
    public String edit(@PathVariable Long id, Model model) {
        ...
        // URL action cho form edit
        model.addAttribute("action", "/admin/the-loai/edit/" + id);
